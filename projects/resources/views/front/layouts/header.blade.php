...
<nav id="mainNav">
  <div class="container">
    ...
    <div id="mobileMenu">
      ...
      <div class="mob-sub">
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-shield-halved" style="color:var(--blue)"></i> Life Insurance</a>
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-heart-pulse" style="color:#0d9488"></i> Health Insurance</a>
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-car" style="color:#ea580c"></i> Motor Insurance</a>
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-file-contract" style="color:#4f46e5"></i> Term Insurance</a>
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-chart-line" style="color:#e11d48"></i> Investment Plans</a>
        <a href="{{url('/')}}" class="mob-sublink"><i class="fas fa-users" style="color:#d97706"></i> Group Insurance</a>
      </div>
