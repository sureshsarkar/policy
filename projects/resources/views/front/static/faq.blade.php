...
.faq-header{    font-family: GothamBold1;
  font-size: 42px;
...
.faq-question {
  padding: 5px 0;    font-family: GothamBold1;
  border-bottom: 1px dotted #ccc;
}

.panel-title {
  font-size: 24px;    font-family: GothamBold1;
  width: 100%; color:#fff;
  position: relative;
  margin: 0;
...
.panel-content {
  font-size: 20px;    font-family: GothamBold1;
  padding: 0px 1px;
...
.plus {
  ...
  z-index: 5;
  font-size: 42px;    font-family: GothamBold1;
  line-height: 100%;
...
{{--
    <section class="banner-wrapper">
        ...
        <div class="banner-shape">
            <img src="{{asset('front/images/banner-shape.png')}}" alt="banner-shape">
        </div>
    </section>
--}}
            ...
            <div class="parti-head">
                ...
                <div class="row mt-5 pt-5">
                 ...
                 {{--   <div class="col-lg-2 col-md-2 col-12">
                        <div class="guide-img">
                            <img src="{{asset('front/images/logo.png')}}" alt="loho">
                            <img src="{{asset($data->image)}}" alt="faqs">
                        </div>
                    </div>--}}
                </div>
            </div>
