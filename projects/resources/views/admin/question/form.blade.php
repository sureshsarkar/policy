<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("category") !!}
            {!! Form::select("category_id",ModelHelper::getCareerLocationSelect(),null,["class"=>"form-control"]) !!}
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("publish") !!}
            {!! Form::select("publish",["published"=>"published","unpublished"=>"unpublished"],'published',["class"=>"form-control","required"=>"required"]) !!}
