<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("Breaking News Text") !!}
            {!! Form::text("breaking_news_text",null,["class"=>"form-control"]) !!}
            <span class="text-danger">{{ $errors->first("title")}}</span>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("Breaking News Text Slug") !!}
            {!! Form::text("breaking_news_text_slug",null,["class"=>"form-control"]) !!}
            <span class="text-danger">{{ $errors->first("title")}}</span>
        </div>
    </div>
