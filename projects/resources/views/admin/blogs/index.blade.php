                    ...
                    @foreach($data as $client)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{!! route($route.'.deactive', [$client->id]) !!}" class="btn btn-outline-success btn-xs raw-margin-right-8"> Unpublished</a>
                              @else

                                <a href="{!! route($route.'.active', [$client->id]) !!}" class="btn btn-outline-danger btn-xs raw-margin-right-8"> Published</a>
                              @endif
                            </td>
                            ...
                            <td>
                              @if($client->featureImage)
                                    <img src="{{ asset($client->featureImage) }}" width="100" > 
                              @endif
                            </td>
