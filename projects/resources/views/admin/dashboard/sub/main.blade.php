...
<div class="row">
	...
	<div class="col-md-9">
		<div class="form-group">
			...
			<textarea class="form-control" name="input['newsletter']" placeholder="newsletter">{{ ModelHelper::getDataFromSetting('newsletter') }}</textarea>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-md-3"><strong>Alternate Email</strong></div>
	<div class="col-md-9">
		<div class="form-group">
			<input type="text" class="form-control" name="input['email1']" value="{{ ModelHelper::getDataFromSetting('email1') }}" placeholder="email1 ">
		</div>
	</div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-md-9">
        <div class="form-group">
            <input type="text" class="form-control" name="input['open-office']" value="{{ ModelHelper::getDataFromSetting('open-office') }}" placeholder="open-office ">
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-9">
        <div class="form-group">
            <input type="text" class="form-control" name="input['office-time']" value="{{ ModelHelper::getDataFromSetting('office-time') }}" placeholder="office-time ">
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-9">
        <div class="form-group">
            <input type="text" class="form-control" name="input['weekend-closed']" value="{{ ModelHelper::getDataFromSetting('weekend-closed') }}" placeholder="weekend-closed">
        </div>
    </div>
</div>
...
<div class="row ">
	...
	<div class="col-md-9">
		<div class="form-group">
			<textarea type="text" class="form-control" name="input['other-thing-on-head']"  placeholder="Other Thing on head">{{ ModelHelper::getDataFromSetting('other-thing-on-head') }}</textarea>
		</div>
	</div>
</div>
