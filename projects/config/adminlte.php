...
return [
    ...
    */
    ...
    'menu' => [
        ...
        //    ["text"=>"Breaking News","url"=>"admin/breaking-news","permission"=>"admin",'icon' => 'fas fa-fw fa-image'],
        //    ["text"=>"News Post","url"=>"admin/news-post","permission"=>"admin",'icon' => 'fas fa-fw fa-image'],
