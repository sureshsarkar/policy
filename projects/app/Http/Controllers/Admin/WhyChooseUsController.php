...
class WhyChooseUsController extends Controller{
    ...
    public function __construct(WhyChooseUs $model){
        $this->model=$model;
        $this->admin_base_url="why-choose-us.index";
        $this->admin_view="admin.why-choose-us";
    }
    ...
    public function store(Request $request){
        ...
        //     $data['image'] = Upload::fileUpload($request->file("image"),"why-choose-us");
        // }
        // if ($request->hasFile("bannerImage")) {
        //     $data['bannerImage'] = Upload::fileUpload($request->file("bannerImage"),"why-choose-us");
        // }
