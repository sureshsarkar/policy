                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                              <?php echo e($client->blogCategory->title); ?>
                            ...
                            <td>
                                ...
                                <a href="<?php echo route($route.'.deactive', [$client->id]); ?>" class="btn btn-outline-success btn-xs raw-margin-right-8"> Unpublished</a>
                              <?php else: ?>

                                <a href="<?php echo route($route.'.active', [$client->id]); ?>" class="btn btn-outline-danger btn-xs raw-margin-right-8"> Published</a>
                              <?php endif; ?>
                            </td>
                            ...
                            <td>
                              <?php if($client->featureImage): ?>
                                    <img src="<?php echo e(asset($client->featureImage)); ?>" width="100" > 
                              <?php endif; ?>
                            </td>
...
<script>
  ...
  $("#data-table-gaurav").DataTable({"lengthMenu": [[ 50, -1], [ 50, "All"]],dom: "<'row'<'col-sm-3'l><'col-sm-3'f><'col-sm-6'p>>" +
   ...
   $(document).on("click",".delete-checkbox",function(){
      ajaxCallCheckBoxDelete("<?php echo e(route('multipleDelete','blogs')); ?>","<?php echo e(route('blogs.index')); ?>","blogs");
  });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed-softwares\xampp-8.2.12\htdocs\laravel-projects\kharido-policy\projects\resources\views/admin/blogs/index.blade.php ENDPATH**/ ?>