...
<?php $__env->startSection('container'); ?>
    ...
    <?php
        $TopStories = App\Models\NewsPost::with('parentname')
            ->where('top_stories_news', 'yes')
            ->where('publish', 'published')
            ->limit(10)
            ->select('id', 'name', 'seo_url', 'bannerImage', 'is_parent')
            ->get();
    ?>
            ...
            <div class="container">
                <div class="top-stories-inner">
                    ...
                    <div class="owl-carousel ts-slider">
                        <?php $__currentLoopData = $TopStories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
    ...
    <section class="gulf-tech-wrapp">
        <div class="container">
            <div class="row">
                ...
                <?php
                    $GulfSpotlight = App\Models\NewsPost::with('parentname')
                        ->where('is_parent', 24)
                        ->where('publish', 'published')
                        ->limit(10)
                        ->select('id', 'name', 'seo_url', 'bannerImage', 'is_parent', 'description')
                        ->get();

                    // pre($GulfSpotlight);

                ?>
                <?php if(count($GulfSpotlight) > 0): ?>
                    ...
                    <div class="col-lg-8 col-md-12 col-12">
                        <div class="gulf-main">
                            ...
                            <div class="owl-carousel gulf-slider">
                                ...
                                <?php $__currentLoopData = $GulfSpotlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item">
                                        <a href="<?php echo e(url('news/' . $c->seo_url)); ?>">
                                            <div class="gulf-box">
                                                <img src="<?php echo asset($c->bannerImage ?? 'front/images/g1.jpg'); ?>">
                ...
                <?php
                    $TechBusiness = App\Models\NewsPost::with('parentname')
                        ->whereIn('is_parent', [27, 28])
                        ->where('publish', 'published')
                        ->limit(10)
                        ->select('id', 'name', 'seo_url', 'bannerImage', 'is_parent')
                        ->get();
                ?>
                <?php if(count($TechBusiness) > 0): ?>
                    <div class="col-lg-4 col-md-12 col-12">
                        <div class="tech-main">
                            <div class="trending-headline">
                                <div class="trending-headline-inn">
                                    ...
                                    <ul>
                                        ...
                                        <?php $__currentLoopData = $TechBusiness; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <img src="<?php echo asset($c->bannerImage ?? 'front/images/th.jpg'); ?>">
    ...
    <?php
        $WorldNews = App\Models\NewsPost::with('parentname')
            ->whereIn('is_parent', [19])
            ->where('publish', 'published')
            ->limit(10)
            ->select('id', 'name', 'seo_url', 'bannerImage', 'is_parent', 'description')
            ->get();
            ...
            <div class="container">
                <div class="top-stories-inner">
                    ...
                    <div class="owl-carousel world-slider">
                        <?php $__currentLoopData = $WorldNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <a href="<?php echo e(url('news/' . $c->seo_url)); ?>">
                                    <div class="gulf-box">
                                        <img src="<?php echo asset($c->bannerImage ?? 'front/images/w1.jpg'); ?>">
                                        <h4><?php echo $c->name; ?></h4>
                                        <p><?php echo $c->description; ?>​</p>
                                    </div>
                                </a>
                        ...
                        <div class="mj-vodeo">
                            <div class="video__wrapper">
                                ...
                                <button type="button" class="video__play-button" data-button-state="pause">
                                    <svg class="video__play-button-icon video__play-button-icon--play"
                                    ...
                                    <svg class="video__play-button-icon video__play-button-icon--pause"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 140">
                                        <path fill-rule="evenodd" clip-rule="evenodd" fill="white"
                                            d="M70 140L70 140c-38.7 0-70-31.3-70-70v0C0 31.3 31.3 0 70 0h0c38.7 0 70 31.3 70 70v0C140 108.7 108.7 140 70 140z" />
                                        <rect fill-rule="evenodd" clip-rule="evenodd" x="56" y="50.8" class="st1"
                                            width="8.8" height="38.5" />
                                        <rect fill-rule="evenodd" clip-rule="evenodd" x="75.2" y="50.8" class="st1"
                                            width="8.8" height="38.5" />
                                    </svg>
                                </button>
                                <video data-state="pause" playsinline poster="<?php echo asset($data->image ?? 'front/images/video.jpg'); ?>">
                                    <source src="<?php echo asset($data->video) ?? ''; ?>" type="video/mp4">
    ...
    <!--===========================================Video Section start========================================-->
    <?php
        $VideoSection = App\Models\VideoSection::where('publish', 'published')->limit(10)->get();
    ?>
    <?php if(count($VideoSection) > 0): ?>
        <section class="top-stories-wrapp">
            <div class="container">
                <div class="top-stories-inner">
                    <div class="top-stories-head">
                    ...
                    <div class="owl-carousel world-slider">
                        ...
                        <?php $__currentLoopData = $VideoSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <div class="mj-vodeo">
                                    <div class="video__wrapper">
                                        ...
                                        <video data-state="pause" playsinline poster="<?php echo asset($c->thumbnail ?? 'front/images/v1.jpg'); ?>"">
                                            <source src="<?php echo asset($c->video) ?? ''; ?>" type="video/mp4">
                                        </video>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp8.2\htdocs\laravel\majlix-news\projects\resources\views/front/static/home.blade.php ENDPATH**/ ?>