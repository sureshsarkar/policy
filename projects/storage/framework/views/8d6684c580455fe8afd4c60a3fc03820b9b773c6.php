                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($client->pageType->name ?? ''); ?>
                                        ...
                                        <td>
                                            <?php if($client->image): ?>
                                                <?php if(preg_match('/\.(jpeg|jpg|png|gif)$/i', asset($client->image))): ?>
                                                    <img src="<?php echo e(asset($client->image)); ?>" width="100">
                                                <?php else: ?>
                                                    <video width="100" height="100" controls>
                                                        <source src="<?php echo e(asset($client->image)); ?>" type="video/mp4">
                                                    </video>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </td>
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed-softwares\xampp-8.2.12\htdocs\laravel-projects\kharido-policy\projects\resources\views/admin/services/index.blade.php ENDPATH**/ ?>