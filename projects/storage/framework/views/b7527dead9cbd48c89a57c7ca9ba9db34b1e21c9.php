                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($client->thumbnail); ?></td>

                                        <td>
                                            <?php if($client->status == 'active'): ?>
                                                <a href="<?php echo route($route . '.deactive', [$client->id]); ?>"
                                                    class="btn btn-outline-success btn-xs raw-margin-right-8"> Unpublished</a>
                                            <?php else: ?>
                                                <a href="<?php echo route($route . '.active', [$client->id]); ?>"
                                                    class="btn btn-outline-danger btn-xs raw-margin-right-8"> Published</a>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            ...
                                            <a href="<?php echo route($route . '.copyData', [$client->id]); ?>"
                                                class="btn btn-outline-info btn-xs raw-margin-right-8"><i
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $(document).on("click", ".delete-checkbox", function() {
            ajaxCallCheckBoxDelete("<?php echo e(route('multipleDelete', 'galleries')); ?>", "<?php echo e(route('galleries.index')); ?>",
                "galleries");
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp8.2\htdocs\laravel\voting-app\projects\resources\views/admin/galleries/index.blade.php ENDPATH**/ ?>