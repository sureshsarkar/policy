<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <?php echo Form::label("Breaking News Text"); ?>

            <?php echo Form::text("breaking_news_text",null,["class"=>"form-control"]); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <?php echo Form::label("Breaking News Text Slug"); ?>

            <?php echo Form::text("breaking_news_text_slug",null,["class"=>"form-control"]); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <?php echo Form::label("Banner Title"); ?>
...
<?php /**PATH E:\Xampp8.2\htdocs\laravel\majlix-news\projects\resources\views/admin/breaking-news/form.blade.php ENDPATH**/ ?>