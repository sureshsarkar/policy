<div class="row">
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($data)): ?>
                        <?php if($data->image2 != ''): ?>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input custom-control-input-danger" name="remove_image2"
                                    value="yes" type="checkbox" id="remove_image2">
    ...
    <div class="col-md-4 ">
        <div class="form-group">
            ...
            <?php echo Form::select('templete', Helper::getTempletes(), null, [
                'class' => 'form-control',
                'required' => 'required',
            ]); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <?php echo Form::select('is_parent', ModelHelper::getPageSelectList(), null, [
                'class' => 'form-control',
...
<?php if(isset($data)): ?>
    <?php if($data->templete == 'about'): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?php echo Form::label('Subscription'); ?>
...
<?php if(isset($data)): ?>
    <?php if($data->templete == 'home'): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?php echo Form::label('Transparency'); ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?php echo Form::label('Participate'); ?>
...
<?php /**PATH D:\installed-softwares\xampp-8.2.12\htdocs\laravel-projects\kharido-policy\projects\resources\views/admin/cms/form.blade.php ENDPATH**/ ?>