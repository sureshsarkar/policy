...
<script>
  $("#data-table-gaurav").DataTable();
   $(document).on("click",".delete-checkbox",function(){
      ajaxCallCheckBoxDelete("<?php echo e(route('multipleDelete','our-teams')); ?>","<?php echo e(route('our-teams.index')); ?>","our-teams");
  });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 8.2\htdocs\laravel\kharido-policy\projects\resources\views/admin/our-teams/index.blade.php ENDPATH**/ ?>