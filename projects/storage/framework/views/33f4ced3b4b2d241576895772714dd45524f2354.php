<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <?php echo Form::select("publish",["published"=>"Published","draft"=>"draft","unpublished"=>"Unpublished"],'null',["class"=>"form-control","required"=>"required"]); ?>
...
</div><?php /**PATH D:\installed-softwares\xampp-8.2.12\htdocs\laravel-projects\kharido-policy\projects\resources\views/admin/blogs/form.blade.php ENDPATH**/ ?>