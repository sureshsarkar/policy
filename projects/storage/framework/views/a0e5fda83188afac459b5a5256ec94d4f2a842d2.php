...
<footer class="footer">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="foot-logo">
                <img src="<?php echo e(asset($setting_data['footer_logo'] ?? 'front/images/logo.png')); ?>" alt="Logo">Policy<span>Kholo</span>
                </div>
...
<?php /**PATH D:\installed-softwares\xampp-8.2.12\htdocs\laravel-projects\policy-kholo\projects\resources\views/front/layouts/footer.blade.php ENDPATH**/ ?>