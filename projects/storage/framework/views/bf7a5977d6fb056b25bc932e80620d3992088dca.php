<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <?php if(isset($data)): ?>
                <?php if($data->image2!=""): ?>
                    <img src="<?php echo e(asset(($data->image2))); ?>" width="100px;" >
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
...
<?php /**PATH E:\Xampp8.2\htdocs\laravel\majlix-news\projects\resources\views/admin/sliders/form.blade.php ENDPATH**/ ?>