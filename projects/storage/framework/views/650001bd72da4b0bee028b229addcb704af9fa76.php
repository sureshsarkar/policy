...
<?php
    $name="Company Users";$route="customers";
?>
...
<td>
    <?php echo e($client->address); ?> <br><?php echo e($client->city); ?><br><?php echo e($client->country); ?>
                            ...
                            <td>
                                ...
                                <form method="post" action="<?php echo route($route.'.destroy', [$client->id]); ?>"
                                    ...
                                    <button type="submit" class="btn btn-outline-danger btn-xs raw-margin-right-8"
                                            onclick="return confirm('Are you sure you want to delete this <?php echo e(Str::singular($name)); ?>?')"><i
...
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp8.2\htdocs\laravel\voteproject\projects\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>