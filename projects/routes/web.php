...
Route::group(["prefix" => "admin", "namespace" => "Admin", "middleware" => ["auth"]], function () {
    ...
    Route::post('/update-news-type', "DashboardController@updateNewsType")->name("update-news-type");
    ...
    Route::get("news-post/copydata/{id}", "SliderController@copyData")->name("news-post.copyData");
    Route::get("breaking-news/copydata/{id}", "SliderController@copyData")->name("breaking-news.copyData");
    ...
    Route::resources([
        ...
        'breaking-news' => BreakingNewsController::class,
        'news-post' => NewsPostController::class,
        'video-section' => VideoSectionController::class,
...
Route::post("send-otp", "PageController@sendOtp")->name("send-otp");
Route::post("verify-otp", "PageController@verifyOtp")->name("verify-otp");
Route::post("user-forgot-password", "Employee\Auth\LoginRegisterController@forgotpassword")->name("user.forgot.password");
Route::post("/change-password", "Employee\Auth\LoginRegisterController@changePassword")->name('user-change-password');
Route::group(["middleware" => ["OptimizeMiddleware"]], function () {
    ...
    Route::get("news/{seo_url}", "PageController@singleNews")->name("single-news");
});

Route::group(["prefix" => "user", "middleware" => ["auth:employee"]], function () {
    Route::get("/dashboard", "EmployeeController@index")->name('dashboard');
    Route::post("/vote-now", "EmployeeController@voteNow")->name('vote-now');
    // Route::post("/change-password","EmployeeController@changePassword")->name('user-change-password');
